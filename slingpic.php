...
class Slingpic_Options {
	...
	*/
	public function scripts() {
		...
		wp_register_style( 'slingpic_css', plugins_url( 'slingpic/css/slingpicv2.css' ) );
		wp_enqueue_style( 'slingpic_css' );
	...
	public function script_vars() {
		...
		<script src="http://cdn.slingpic.com/js/slingpic.wp.plugin.js"></script>
		<script>
