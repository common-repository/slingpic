...
Contributors:      Ben Jackson, Pravin Paratey, Ray Jenkin, Stelios Papagrigoriou
...
*	Very important update ensuring that Slingpic is complying with Wordpress Guidlines.
...
Disclaimer: We send requests to our servers to record and display share counts in the plugin. We are collecting user data and by downloading this plugin you are giving us permission to do this.
...
= 5.0.2 =
- *locally hosting css and images*
- unobfuscated code and better description of the plugin
